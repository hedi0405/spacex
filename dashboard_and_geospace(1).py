# -*- coding: utf-8 -*-
"""dashboard and geospace(1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jGLEV10BTCEVE0O_i85p294MAvUg4rGl
...
circle3 = folium.Circle([28.573255,-80.646895], radius=1000, color='#d35400', fill=True).add_child(folium.Popup('NKSC LC-39A'))
...
marker3 = folium.map.Marker(
    ...
    icon=DivIcon(
        icon_size=(20,20),
        icon_anchor=(0,0),
        html='<div style="font-size: 12; color:#d35400;"><b>%s</b></div>' % 'NKSC LC-39A',
        )
    )
...
for index, record in spacex_df.iterrows():
    # TODO: Create and add a Marker cluster to the site map
     marker = folium.map.Marker(list(record[[1,2]]), icon=folium.Icon(color='white', icon_color=spacex_df['marker_color']))                                                                                                                                
